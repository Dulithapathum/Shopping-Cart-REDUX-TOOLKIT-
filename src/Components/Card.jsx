...
const Card = ({ item }) => {
  const dispatch = useDispatch(); // Allows dispatching actions to update the Redux store
  ...
  return (
    ...
    >
      ...
      <button
        ...
        onClick={() => dispatch(addToCart(item))} // Dispatches the addToCart action with item data
      >
        Add To Cart
      </button>
    </div>
